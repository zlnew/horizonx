...
// newInstanceEnv generates a fresh secret set for a instance. adminEmail and
...
func newInstanceEnv(host, adminEmail, adminPass string, allowedOrigins []string) (*instanceEnv, error) {
	...
	// Internal convention: the server listens on :3000 INSIDE the instance
...
// renderInstanceEnv renders the instance's .env. This is the single source of
// truth the server, dashboard, and agent all derive their URLs from.
func renderInstanceEnv(e *instanceEnv) string {
	return fmt.Sprintf(`# HorizonX instance — generated by `+"`horizonx install server`"+`
